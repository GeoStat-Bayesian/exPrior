...
Running `genExPrior` with these arguments, we get the ex-situ prior distribution for $\theta$ as well as the posterior hyperparameters of our Bayesian hierarchical model.
